                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <!-- tombol button -->
                                    <td> <?php echo anchor('operator/Dashboard_admin/detail_admin/' . $adm->id_adm, '<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>') ?> </td>
                                    <td> <?php echo anchor('operator/Dashboard_admin/edit_admin/' . $adm->id_adm, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?> </td>
                                    <td> <?php echo anchor('operator/Dashboard_admin/hapus_admin/' . $adm->id_adm, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?> </td>
                                </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'operator/Dashboard_admin/tambah_admin'; ?>" method="post" enctype="multipart/form-data">
