    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('dkm/Dashboard_dkm/') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('dkm/Dashboard_dkm/data_donatur') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('dkm/Dashboard_dkm/data_admin') ?>">
