                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $dnt->nama ?></td>
                                    <td><?php echo $dnt->email ?></td>
                                    <td><?php echo $dnt->alamat ?></td>
                                    <td><?php echo $dnt->no_wa ?></td>
                                    <td><img style="width: 100px;" src="<?php echo base_url() . '/uploads/' . $dnt->gambar ?>"></td>
                                    <td><?php echo $dnt->password ?></td>
                                    <td><img style="width: 100px;" src="<?php echo base_url() . 'assets/images/' . $dnt->qr_code; ?>"></td>
                                    <!-- tombol button -->
                                    <td> <?php echo anchor('operator/Dashboard_admin/detail_donatur/' . $dnt->id_dnt, '<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>') ?> </td>
                                    <td> <?php echo anchor('operator/Dashboard_admin/edit_donatur/' . $dnt->id_dnt, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?> </td>
                                    <td> <?php echo anchor('operator/Dashboard_admin/hapus_donatur/' . $dnt->id_dnt, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?> </td>
                                </tr>
